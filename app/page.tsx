...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const handleChatStateChange = (event: any) => {
      setHasChatMessages(event.detail?.hasMessages || false);
      setChatSaved(event.detail?.isSaved || false);
      setSavedMessageCount(event.detail?.savedMessageCount || 0);
    };
      ...
      <header className="flex items-center justify-between px-6 py-4 gap-3">
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={!hasChatMessages || chatSaved}
